...
insudeFormInput = (event)=>{
    if (event.target.name === "delay") formInputValue.delay = Number(event.target.value);
    if (event.target.name === "step") formInputValue.step = Number(event.target.value);
    if (event.target.name === "amount") formInputValue.amount = Number(event.target.value);
};
